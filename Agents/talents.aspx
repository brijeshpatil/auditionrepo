<%@ page title="" language="C#" masterpagefile="~/Agents/agent.master" autoeventwireup="true" inherits="Agents_Default, App_Web_rmxupoaz" %>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton4" runat="server" CommandName="sortlist" CssClass="a"
                                    CommandArgument='<%#Eval("user_id")+","+Eval("project_id") %>'>Sortlist</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
